...
#write.csv(y.rep.m1[1,,], file='./data/bl_m1.csv', row.names=FALSE)
...
y.rep.m2[1,,]
#write.csv(y.rep.m2[1,,], file='./data/bl_m2.csv', row.names=FALSE)
...
stops_prev_year = matrix(n.ep.lt10$Occurrences, nrow=30, byrow=TRUE)
